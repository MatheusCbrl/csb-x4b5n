...
function countdownTime(){
	...
	if(isExists('#clock')){
		$('#clock').countdown('2024/09/28', function(event){
...
function initMap() {
	...
	var espaco_nobre = {lat: -29.1349141, lng: -51.1095017};
        var map = new google.maps.Map(document.getElementById('mapa_casamento'), {
		zoom: 4,
		center: espaco_nobre
    });
